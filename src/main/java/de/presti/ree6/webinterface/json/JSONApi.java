package de.presti.ree6.webinterface.json;
...
public class JSONApi {
	...
	public static JSONArray GetData2(Requests type, String url, String post, String authkey) {
		...
		try {
			...
			c.setRequestProperty("User-Agent",
					"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.52 Safari/537.36 Ree6/2021");
			if(!authkey.isEmpty()) {
	...
	public static JSONObject GetData(Requests type, String url, String authkey) {
		Date start = new Date();
		Date preconnect = start;
		Date postconnect = start;
		Date prejson = start;
